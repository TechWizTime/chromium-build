...
echo -e "WARNING: This script will completely remove Chromium from Raspbian"
echo -e "TechWizTime will not be accountable for any loses caused by this script"
